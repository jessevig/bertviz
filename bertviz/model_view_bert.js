...
requirejs(['jquery', 'd3'], function($, d3) {
        ...
        function render() {
            ...
            bertmap.attn = attData.attn;
            bertmap.numLayers = bertmap.attn.length;
            bertmap.numHeads = bertmap.attn[0].length;
        ...
        function renderThumbnail(layerIndex, headIndex) {
            ...
            renderThumbnailAttn(x, y, bertmap.attn[layerIndex][headIndex], layerIndex, headIndex);
        }
