...
requirejs(['jquery', 'd3'],
    function ($, d3) {
        ...
        function render() {
            ...
            gptmap.attn = attention.attn;
            gptmap.numLayers = gptmap.attn.length;
            gptmap.numHeads = gptmap.attn[0].length;
        ...
        function renderThumbnail(layerIndex, headIndex) {
            ...
            renderThumbnailAttn(x, y, gptmap.attn[layerIndex][headIndex], layerIndex, headIndex);
        }
