...
requirejs(['jquery', 'd3'],
  function ($, d3) {
    ...
    function renderHorizLines(svg, id, start_pos, end_pos) {
      var attnMatrix = config.attention[config.att_type].attn[config.layer][config.att_head];
